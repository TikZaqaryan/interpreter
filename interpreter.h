...
void int_(std::string str)
{
        ...
        for (int i = 0; i < str.length(); ++i)
        {
                ...
                if (nstr != "itip")
                {
                        std::cout << " ERROR \n  There is a mmistake in variable type \n ";
                        exit(0);
                }
                ++i;
                break;
        ...
        if (nstr == "itip")
        {
                ...
                for (int i = count; i < str.length(); ++i)
                {
                        ...
                        if (str[i] != ' ')
                        {
                                ...
                                {
                                        std::cout << "ERROR \n The name of variable is declared in wrong way ";
                                        exit(0);
                                }
                                break;
                        }
        ...
        for (int i = count; i < str.length(); ++i)
        {
                ...
                if (str[i] != ' ')
                {
                        ...
                        if (str[i] != '~')
                        {
                                std::cout << " ERROR \n The assignment is done in wrong way \n ";
                                exit(0);
                        }
                        if (str[i] == '~')
                        {
...
void float_(std::string str)
{
        ...
        for (int i = 0; i < str.length(); ++i)
        {
                ...
                if (nstr != "dtip")
                {
                        std::cout << " ERROR \n  There is a mistake in variabel type \n ";
                        exit(0);
                }
                ++i;
                break;
        ...
        if (nstr == "dtip")
        {
                ...
                for (int i = count; i < str.length(); ++i)
                {
                        ...
                        if (str[i] != ' ')
                        {
                                ...
                                {
                                        std::cout << " ERROR \n The name of variabel is dexlared in wrong way ";
                                        exit(0);
                                }
                                break;
                        }
        ...
        for (int i = count; i < str.length(); ++i)
        {
                ...
                if (str[i] != ' ')
                {
                        if (str[i] != '~')
                        {
                                std::cout << " ERROR \n The assignment is done in a wrog way \n ";
                                exit(0);
                        }
                        if (str[i] == '~')
                        {
...
void str_(std::string str)
{
        ...
        for (int i = 0; i < str.length(); ++i)
        {
                ...
                if (nstr != "stip")
                {
                        std::cout << " ERROR \n  There is a mistake in variable type \n ";
                        exit(0);
                }
                ++i;
                break;
                ...
                for (int i = count; i < str.length(); ++i)
                {
                        ...
                        if (str[i] != ' ')
                        {
                                if (str[i] >= 'a' && str[i] <= 'z')
                                {
                                        ...
                                        if (n == 1)
                                        {
                                                std::cout << " ERROR \n There is a variaable with that name ";
                                                exit(0);
                                        }
                                        if (n == 0)
                                        {
                                ...
                                {
                                        std::cout << "ERROR \n The name of varianle is declared in wrong way ";
                                        exit(0);
                                }
                                break;
                        }
        ...
        for (int i = count; i < str.length(); ++i)
        {
                ...
                if (str[i] != ' ')
                {
                        ...
                        if (str[i] != '~')
                        {
                                std::cout << " ERROR \n The assignment is done by wrong way \n ";
                                exit(0);
                        }
                        if (str[i] == '~')
                        {
...
void bool_(std::string str)
{
        ...
        for (int i = count; i < str.length(); ++i)
        {
                ...
                if (str[i] != ' ')
                {
                        ...
                        if (str[i] != '~')
                        {
                                std::cout << " ERROR \n The assighnment is done in a wrong way\n ";
                                exit(0);
                        }
                        if (str[i] == '~')
                        {
...
void print(std::string str)
{
        ...
        do
        {
                ...
                {
                        std::cout << " ";
                        if (imap.count(strcmp[0]) == 1)
                        {
                                std::cout << imap[strcmp[0]];
                        }
                        else if (fmap.count(strcmp[0]) == 1)
                        {
                                std::cout << fmap[strcmp[0]];
                        }
                        else if (smap.count(strcmp[0]) == 1)
                        {
                                std::cout << smap[strcmp[0]];
                        }
                        else if (bmap.count(strcmp[0]) == 1)
                        {
                                std::cout << bmap[strcmp[0]];
                        }
...
void acts(std::string str)
{
        int n = var_name(str[0]);
        if (n == 0)
        {
                return;
        }
                ...
                for (int i = count; i < str.length(); ++i)
                {
                        ...
                        if (str[i] != ':')
                        {
                                if (str[i] != ' ')
                                {
                                        ...
                                        {
                                                std::cout << "ERROR \n You can't do assignmen in this way:";
                                                exit(0);
                                        }
                                }
                        }
...
void condition(std::string str)
{
        ...
        ++i;
        bool true_false = compare(strcmp, strcmp1, c);
        strcmp = "";
        if (true_false)
        {
                while (str[i] == ' ')
                ...
                if (str[i] != '{')
                {
                        std::cout << "error loop'{' scope " << std::endl;
                        exit(0);
                }
                ++i;
                while (str[i] == ' ')
                ...
                do
                {
                        ...
                        if (pop == 0)
                        {
                                std::cout << "error variable1 " << std::endl;
                                exit(0);
                        }
                        if (pop)
                        {
...
bool compare(std::string str1, std::string str2, char gorc)
{
